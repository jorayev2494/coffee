                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            ...
                            <div class="form-group">
                                <div class="nk-int-st">
                                    <input name="about_us" type="text" class="form-control" placeholder="О нас">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            ...
                            <div class="form-group">
                                <div class="nk-int-st">
                                    <input name="copyrite" type="text" class="form-control" placeholder="Копирайт">
                                </div>
                            </div>
                        </div>
                    </div>
