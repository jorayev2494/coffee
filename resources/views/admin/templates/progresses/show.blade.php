        ...
        <div class="animation-single-int">
            ...
            <div class="animation-action">
                ...
                <div class="row mg-t-10">
                    <div class="col-lg-12">
                        <div class="animation-btn">
                            <a class="btn ant-nk-st pulse-ac" href="{{ route('admin.' . $infoCurrentRoute['slug'] . '.edit', $progress->id) }}">Редактировать</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mg-t-10">
                    <div class="col-lg-12">
                        {{--  <div class="animation-btn">  --}}
                            {!! Form::open(["url" => route("admin." . $infoCurrentRoute['slug'] . ".destroy", $progress->id), "method" => "DELETE"]) !!}
