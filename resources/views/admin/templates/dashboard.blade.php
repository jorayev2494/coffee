                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="realtime-wrap notika-shadow mg-t-30">
                        ...
                        <div class="realtime-country-ctn realtime-ltd-mg">
                            ...
                            <div class="realtime-ctn-bw">
                                <div class="realtime-ctn-st">
                                    <span><img src="{{ asset('admin') }}/img/country/1.png" alt="" /></span> <span>United States</span>
                                </div>
                        ...
                        <div class="realtime-country-ctn">
                            ...
                            <div class="realtime-ctn-bw">
                                <div class="realtime-ctn-st">
                                    <span><img src="{{ asset('admin') }}/img/country/2.png" alt="" /></span> <span>Australia</span>
                                </div>
                                <div class="realtime-bw">
                                    <span>Firefox</span>
                                </div>
                        ...
                        <div class="realtime-country-ctn">
                            ...
                            <div class="realtime-ctn-bw">
                                <div class="realtime-ctn-st">
                                    <span><img src="{{ asset('admin') }}/img/country/3.png" alt="" /></span> <span>Brazil</span>
                                </div>
                                <div class="realtime-bw">
                                    <span>Firefox</span>
                                </div>
                                    ...
                                    <ul class="conversation-list">
                                        <li class="clearfix">
                                            <div class="chat-avatar">
                                                <img src="{{ asset('admin') }}/img/post/1.jpg" alt="male">
                                                <i>10:00</i>
                                            </div>
                                        ...
                                        <li class="clearfix odd">
                                            <div class="chat-avatar">
                                                <img src="{{ asset('admin') }}/img/post/2.jpg" alt="Female">
                                                <i>10:01</i>
                                            </div>
                                            <div class="conversation-text">
                                        ...
                                        <li class="clearfix odd">
                                            <div class="chat-avatar">
                                                <img src="{{ asset('admin') }}/img/post/2.jpg" alt="male">
                                                <i>10:02</i>
                                            </div>
                                            <div class="conversation-text">
                                                <div class="ctext-wrap chat-widgets-cn">
